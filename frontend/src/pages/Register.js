    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setLoading(false);
                if(window.showToast) window.showToast("Account created successfully! Welcome to SmartFarm.", "success");
                onRegister();
            }
        } catch (err) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4 relative overflow-hidden">
            ...
            <div className="max-w-md w-full glass-panel bg-white p-10 rounded-3xl shadow-2xl relative z-10 fade-in">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 font-medium mt-2">Join the future of farming.</p>
                </div>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <button 
                        ...
                        className="w-full bg-gray-900 text-white font-bold py-3 px-4 rounded-xl shadow-md hover:bg-gray-800 transition-all disabled:opacity-70 flex items-center justify-center mt-2">
                ...
                <div className="mt-8 text-center text-sm border-t border-gray-100 pt-6">
                    <p className="text-gray-500 font-medium">Already have an account? <span onClick={onNavigateToLogin} className="font-bold text-brand-600 hover:text-brand-500 cursor-pointer">Sign in</span></p>
                </div>
            </div>
        </div>
    );
